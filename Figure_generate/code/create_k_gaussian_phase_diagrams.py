#!/usr/bin/env python
"""
Create phase diagrams for k_gaussian_0.05 and k_gaussian_0.1 simulations.
Generates both phase diagram SVG files using the new simulation data.
"""
...
def classify_vector_decomposition_k_gaussian(a, b, c, sigma):
    ...
    # Tighter distributions (smaller sigma) need more sensitive thresholds
    if sigma <= 0.05:
        # Very tight distribution - more sensitive
        c_threshold = 0.05
        diff_threshold = 0.15
    elif sigma <= 0.1:
        # Medium distribution
...
def create_phase_diagram_for_k_gaussian(sigma, data_path, output_path):
    """Create phase diagram for specific k_gaussian simulation."""
    
    print(f"Creating phase diagram for k_gaussian_{sigma}...")
    ...
    for u_val in u_values:
        ...
        if col_name in data1.columns:
            ...
            if min_length > 0:
                ...
                classifications = [classify_vector_decomposition_k_gaussian(a_values[j], b_values[j], c_values[j], sigma) 
 ...
 <metadata>
  <rdf:RDF xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cc="http://creativecommons.org/ns#" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
   <cc:Work>
    ...
    <dc:creator>
     <cc:Agent>
      <dc:title>50from500 k_gaussian_{sigma} phase diagram</dc:title>
     </cc:Agent>
    </dc:creator>
   </cc:Work>
  </rdf:RDF>
...
" style="fill: none; stroke: #262626; stroke-width: 0.5; stroke-linejoin: miter; stroke-linecap: square"/>
    ...
    print(f"   Data: 50from500 k_gaussian_{sigma} simulation")
...
def main():
    """Generate both k_gaussian phase diagrams."""
    
    print("🧪 Generating k_gaussian phase diagrams...")
    print("=" * 70)
    
    # Configuration for both simulations
    simulations = [
        {
            'sigma': 0.05,
    ...
    for sim_config in simulations:
        ...
        if create_phase_diagram_for_k_gaussian(
            sim_config['sigma'],
