"""
Plot_predictability_S24.py
Purpose: Predictive models for coalescence outcomes with 24 initial species
"""
...
def main():
    ...
    alphas = [0.03, 0.05, 0.04]  # Adjusted for S24
    ...
    for medium, alpha, color in zip(medium_list, alphas, colors):
        ...
        plt.tight_layout()
        plt.savefig(f"Figure/Predictability/Fig_predictability_{medium}_S24.svg", 
