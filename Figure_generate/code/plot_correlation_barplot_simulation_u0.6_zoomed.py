#!/usr/bin/env python3
"""
Create ZOOMED barplot for simulation data at u=0.6 with y-axis range -0.2 to 0.4
"""
...
def plot_barplot_u06_zoomed(results, save_dir):
    """
    Create ZOOMED bar plot for u=0.6 simulation data with y-axis range -0.2 to 0.4.
    """
...
def main():
    """Main function."""
    print("="*80)
    print("CREATING ZOOMED BARPLOT FOR SIMULATION u=0.6")
    print("="*80)
    ...
    plot_barplot_u06_zoomed(results, save_dir)
