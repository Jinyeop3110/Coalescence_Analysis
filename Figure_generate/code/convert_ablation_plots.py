#!/usr/bin/env python
"""
Convert ablation phase diagrams to PNG and PDF formats.
"""
...
def main():
    ...
    ablation_sessions = [
        {
            ...
            "output_base": "Figure/PhaseDiagram_ablation/Fig_phase_diagram_ablation_gaussian"
        },
        {
            "name": "gamma",
            "json_file": "Simulation_Data/48species_ablation_gamma/Community_ablation_gamma.json",
            "output_base": "Figure/PhaseDiagram_ablation/Fig_phase_diagram_ablation_gamma"
        }
    ]
    ...
    for session in ablation_sessions:
        print(f"\nProcessing {session['name']}...", flush=True)
