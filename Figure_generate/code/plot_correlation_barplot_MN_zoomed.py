#!/usr/bin/env python3
"""
Create zoomed MN correlation barplot with y-axis range -0.2 to 0.4
"""
...
def plot_zoomed_barplot(results, save_dir, condition='MN'):
    """
    ...
    save_path_png = os.path.join(save_dir, f'correlation_barplot_{condition}_zoomed.png')
    plt.savefig(save_path_png, dpi=300, bbox_inches='tight')
    print(f"Saved: {save_path_png}")

    save_path_svg = os.path.join(save_dir, f'correlation_barplot_{condition}_zoomed.svg')
...
def main():
    ...
    print("\n" + "="*80)
    print("Creating zoomed visualization...")
    print("="*80)

    plot_zoomed_barplot(results, save_dir, condition='MN')
