#!/usr/bin/env python
"""
Create final phase diagrams for both 30from300 and 50from500 k_gaussian simulations.
Uses full u-range data (0.1-1.2) with clean naming.
"""
...
def classify_vector_decomposition_k_gaussian(a, b, c, sigma, system_type):
    """
        ...
        for u_val in u_values:
            ...
            if col_name in data1.columns:
                ...
                if min_length > 0:
                    ...
                    classifications = [classify_vector_decomposition_k_gaussian(a_values[j], b_values[j], c_values[j], sigma, system_type) 
 ...
 <metadata>
  <rdf:RDF xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cc="http://creativecommons.org/ns#" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
   <cc:Work>
    ...
    <dc:creator>
     <cc:Agent>
      <dc:title>{system_type} k_gaussian_{sigma} phase diagram</dc:title>
     </cc:Agent>
    </dc:creator>
   </cc:Work>
  </rdf:RDF>
...
def main():
    """Create final phase diagrams for all k_gaussian simulations."""
    
    print("🎨 Creating final phase diagrams")
    print("Clean naming without '_complete' suffix")
    print("=" * 60)
    
    # Configuration for all simulations
    simulations = [
        # 30from300 simulations
        {
            'sigma': 0.05,
            'system': '30from300',
            'data_path': 'Simulation_Data/complete_k_gaussian_0.05_defined_pool_nooverlap_30from300_natural_full/Similarity.xlsx',
            'output_path': 'Figure/PhaseDiagram/Fig_phase_diagram_Simul_30from300_k_gaussian_0.05.svg'
        },
        {
            'sigma': 0.1,
            'system': '30from300',
            'data_path': 'Simulation_Data/complete_k_gaussian_0.1_defined_pool_nooverlap_30from300_natural_full/Similarity.xlsx',
            'output_path': 'Figure/PhaseDiagram/Fig_phase_diagram_Simul_30from300_k_gaussian_0.1.svg'
        },
        {
            'sigma': 0.15,
            'system': '30from300',
            'data_path': 'Simulation_Data/complete_k_gaussian_0.15_defined_pool_nooverlap_30from300_natural_full/Similarity.xlsx',
            'output_path': 'Figure/PhaseDiagram/Fig_phase_diagram_Simul_30from300_k_gaussian_0.15.svg'
        },
        # 50from500 simulations  
        {
            'sigma': 0.05,
            'system': '50from500',
            'data_path': 'Simulation_Data/new_k_gaussian_0.05_defined_pool_nooverlap_50from500_natural_full/Similarity.xlsx',
            'output_path': 'Figure/PhaseDiagram/Fig_phase_diagram_Simul_50from500_k_gaussian_0.05.svg'
        },
        {
            'sigma': 0.1,
            'system': '50from500', 
            'data_path': 'Simulation_Data/new_k_gaussian_0.1_defined_pool_nooverlap_50from500_natural_full/Similarity.xlsx',
            'output_path': 'Figure/PhaseDiagram/Fig_phase_diagram_Simul_50from500_k_gaussian_0.1.svg'
        },
        {
            'sigma': 0.15,
            'system': '50from500',
            'data_path': 'Simulation_Data/new_k_gaussian_0.15_defined_pool_nooverlap_50from500_natural_full/Similarity.xlsx',
            'output_path': 'Figure/PhaseDiagram/Fig_phase_diagram_Simul_50from500_k_gaussian_0.15.svg'
        }
    ]
    ...
    print(f"\n🎉 Final phase diagram generation complete!")
