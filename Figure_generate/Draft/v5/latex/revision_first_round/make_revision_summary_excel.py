...
OUT_PATH = "/Users/jysong/Desktop/Gore_lab/Sequencing/Coalescence_session_20230404/Figure_generate/Draft/v5/latex/revision/revision_response_summary.xlsx"
...
ROWS = [
    ...
    ("P1.1", "Phase 1", "R2",
     ...
     "Already corrected in the current v5 source — no further change needed.",
     "COMPLETE", "100%"),
