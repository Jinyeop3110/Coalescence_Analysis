...
| P3.2 | R1-2 | Strict pH contrast and Dominance | Use the Extended Data Fig. 8 strict pH contrast (one parent pH `<6.5`, the other pH `>7.5`) and avoid the superseded broad pH split | Integrated in v4 response/results/Extended Data Fig. 8 | 90% — completed from existing pH + outcome data |
