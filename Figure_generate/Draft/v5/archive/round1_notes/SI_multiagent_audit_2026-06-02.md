...
The Note covers parental OD/biomass imbalance, pool size, pH feedback, dominant-species removal, additive nulls, and facilitation-related model variants, but the first paragraph only frames OD.
