...
**ASV-based assembly survival ratio (realized parental ASV richness / inoculated pool size):**
...
### Output Figures
- `pool_size_analysis.{svg,pdf,png}` — 6-panel: (A) realized parental richness, (B) ASV-based assembly survival ratio, (C) experimental Dominance fraction, (D) experimental pairwise species selection, (E) model Dominance fraction, (F) model pairwise species selection
- `pool_size_analysis_AB.{svg,pdf,png}` — 2-panel export of richness and assembly survival ratio
