...
Panel A supports the operational claim that invasion resistance and Dominance increase across the nutrient gradient. Panel B shows that enrichment also changes community structure, so nutrient concentration is not a pure scalar proxy for pairwise coefficients. Panel C shows that pH-mediated environmental feedbacks help explain winner identity in the Nutr+ top-down regime, while not being the sole explanation for outcome class.
