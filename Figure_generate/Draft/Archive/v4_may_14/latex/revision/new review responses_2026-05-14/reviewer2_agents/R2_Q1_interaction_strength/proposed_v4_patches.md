# Proposed v4 Patches: Reviewer 2 Q1

These patches are proposed only. This worker did not edit authoritative v4 manuscript, SI, revision, or response files.

## 1. Results subsection title

File: `Figure_generate/Draft/v4/latex/sections/results.tex`
...
File: `Figure_generate/Draft/v4/latex/sections/introduction.tex`
...
File: `Figure_generate/Draft/v4/latex/sections/discussion.tex`
...
## 7. No SI patch required beyond current v4 text
