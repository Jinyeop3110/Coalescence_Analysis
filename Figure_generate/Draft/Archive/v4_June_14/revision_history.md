...
- **Files changed**
  - `latex/supplementary_sections/skewness_null_model.tex`
    - Added an explicit definition of `atan2(u,v)` as the two-argument arctangent, including its boundary behavior at `v=0`.
  - `latex/supplementary_sections/figures.tex`
    ...
    - Clarified in Supplementary Figs.~10--12 that the PDI formula uses the two-argument arctangent definition from Supplementary Note~1.
  ...
  - `latex/revision/response/reviewer1_response.tex`
    - Corrected the R1-1B PDI formula from `\arctan(u/v)` to `\operatorname{atan2}(u,v)`.
    - Clarified that `atan2` is the two-argument arctangent in the R1-1B caption.
  ...
  - `../../code/Figure_revision/R1_1_OD_density/analyze_OD_density.py` and `../../code/Figure_revision/R2_3_continuous_similarity/analyze_continuous_similarity.py`
    - Updated the visible PDI axis labels in regenerated response/supplementary figure assets from `arctan(u/v)` wording to `atan2(u,v)` wording.
    - Updated the R1-1 OD-vs-PDI script calculation to use `np.arctan2(u, v)` directly, matching the manuscript definition.
  ...
  - `latex/revision/revision_figure_folder/source.md`
    - Updated figure-source provenance to use `atan2(u,v)` rather than `arctan(u/v)` for the affected PDI figures.
...
- **Verification**
  ...
  - Regenerated the affected response/supplementary figure PDFs and checked extracted PDF text for corrected `atan2` labels.
...
- **Affected reviewer points**: Cross-cutting SI readability and response traceability, especially R1-1 biomass loading, R1-4 pool size, R2 natural-community caveats, and R3 null/robustness controls.
- **Files changed**
...
- **What changed**
  ...
  - Added local subheadings to Supplementary Note~5 so biomass loading, pool-size controls, pH alternatives, dominant-species circularity, additive/geometric null effects, and model-scope controls are easier to scan.
