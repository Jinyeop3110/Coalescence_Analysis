...
- **Description**: Three-panel Base-medium continuous-distribution figure. Panels show manuscript PDI, computed as `(2/pi) atan2(u,v)` with atan2 as the two-argument arctangent, and reflection-symmetrized for visualization; asymmetry magnitude `y`; and squared retention magnitude `r^2`. Integrated as Supplementary Fig. 10.
...
- **Code**: `Figure_generate/code/Figure_revision/R2_3_continuous_similarity/analyze_continuous_similarity.py`
- **Description**: Three-by-three per-medium continuous-distribution figure. Rows show Nutr-, Base, and Nutr+; columns show manuscript PDI, computed as `(2/pi) atan2(u,v)` with atan2 as the two-argument arctangent, and reflection-symmetrized for visualization; asymmetry magnitude `y`; and squared retention magnitude `r^2`. Used as Response Fig. R2-3.
