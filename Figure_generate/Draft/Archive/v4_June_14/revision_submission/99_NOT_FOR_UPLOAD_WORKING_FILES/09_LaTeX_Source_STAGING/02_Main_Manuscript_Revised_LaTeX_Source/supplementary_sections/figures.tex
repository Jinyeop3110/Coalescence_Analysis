...
% Supple Fig 3 - Post-assembly interaction matrix (added for R1-7)
\begin{figure}[H]
\centering
...
% Supple Fig 10 - Base-medium continuous PDI / retention marginals (added for R2-3)
\begin{figure}[H]
\centering
...
% Supple Fig 11 - Nutr-minus continuous PDI / retention marginals (added for R2-3)
\begin{figure}[H]
\centering
...
% Supple Fig 12 - Nutr-plus continuous PDI / retention marginals (added for R2-3)
\begin{figure}[H]
\centering
...
% Supple Fig 15 - Parental OD versus pairwise selection correlation (added for R1-1)
\begin{figure}[H]
\centering
...
% Supple Fig 16 - Dominant-species removal control for Fig. 5C (added for R1-3)
\begin{figure}[H]
\centering
...
% Supple Fig 36 - Excess same-parent shared fate vs mu (added for R2-4)
\begin{figure}[H]
\centering
...
% Supple Fig 37 - Boundary sensitivity for R2-3
\begin{figure}[H]
\centering
...
% Supple Fig 38 - Simulation simple additive null comparison for R3-3
\begin{figure}[H]
\centering
...
% Supple Fig 46 - Strict pH contrast response analysis
\begin{figure}[H]
\centering
