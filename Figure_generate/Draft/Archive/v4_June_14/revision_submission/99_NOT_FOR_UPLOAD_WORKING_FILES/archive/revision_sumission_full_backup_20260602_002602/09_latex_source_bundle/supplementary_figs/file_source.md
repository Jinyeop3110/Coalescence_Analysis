...
- **Description**: Base-medium continuous distributions of PDI, asymmetry magnitude, and squared retention magnitude. Used as Supplementary Fig. 29.
...
- **Code**: `Figure_generate/code/Figure_revision/R2_3_continuous_similarity/analyze_continuous_similarity.py`
- **Description**: Nutr-minus continuous distributions of PDI, asymmetry magnitude, and squared retention magnitude. Used as Supplementary Fig. 30.
...
- **Code**: `Figure_generate/code/Figure_revision/R2_3_continuous_similarity/analyze_continuous_similarity.py`
- **Description**: Nutr-plus continuous distributions of PDI, asymmetry magnitude, and squared retention magnitude. Used as Supplementary Fig. 31.
...
- **Description**: Signed parental-community OD difference versus PDI, separately for Nutr-, Base, and Nutr+. Added as Supplementary Fig. 35 for the Reviewer 1 biomass-loading control.
...
- **Description**: Simple additive null model comparison for Base medium coalescence outcomes. Panel A shows the manuscript-style similarity map with simple additive null model outcomes, observed coalesced communities, and example null-to-observed arrows. Panel B shows paired PDI/asymmetry shifts from each simple additive null model outcome to its corresponding observed outcome. Panel C shows class transitions from simple additive null model outcomes to observed coalesced communities. Promoted from Supplementary Fig. 38 to Extended Data Fig. 3 for the Reviewer 3 dimensionality/additive-null response.
...
- **Description**: Reciprocal pair-coupling robustness analysis. Reciprocal coefficient structure is varied from antisymmetric exploitation (`p < 0`, one coefficient in a converted pair is negative) through the iid competitive baseline (`p = 0`) to symmetric competition (`p > 0`, both converted coefficients are positive and equal). Added together as Supplementary Fig. 40 for the Reviewer 3 interaction-structure response.
