...
| C | Acidic community dominance fraction in strict pH-contrast pairs: Base 23/41 (56.1%), Nutr+ 29/32 (90.6%). | `Figure_generate/Draft/v4/latex/sections/results.tex` pH paragraph and `Figure_generate/Draft/v4/latex/supplementary_sections/extended_data.tex` Extended Data Fig. 8 caption. |
