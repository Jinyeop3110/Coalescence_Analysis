...
\begin{figure}[H]
\centering
\includegraphics[width=0.88\textwidth]{internal_Q5_phase_pH.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{marginal_distributions_by_medium.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{boundary_sensitivity_by_medium.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{Fig_R2_5_natural_taxonomic_distinctness.png}
