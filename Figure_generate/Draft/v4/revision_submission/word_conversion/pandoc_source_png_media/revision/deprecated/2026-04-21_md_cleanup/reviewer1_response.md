...
**Superseded note:** This deprecated draft used the earlier non-strict pH split. The current v4 response uses only the Extended Data Fig. 8 strict pH-contrast definition, where one parent has pH `<6.5` and the other has pH `>7.5`.
