...
\subsubsection*{\rev{Strain library, coalescence examples, and assembly filtering}}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{supplementary_figs/Fig_1-3_phylogeny_tree.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{supplementary_figs/timeseries_Base_combined.png}
...
\subsubsection*{\rev{Baseline gLV parameter sensitivity}}

% Supple Fig 4 - Simulation: growth-rate heterogeneity
\begin{figure}[H]
\centering
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{supplementary_figs/Fig_phase_diagram_ablation_growth_std01.png}
    \caption{Growth rate: mean 1, standard deviation 0.1}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{supplementary_figs/Fig_phase_diagram_ablation_growth_std02.png}
...
\centering
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{supplementary_figs/Fig_phase_diagram_ablation_k_std01.png}
    \caption{Carrying capacity: mean 1, standard deviation 0.1}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{supplementary_figs/Fig_phase_diagram_ablation_k_std02.png}
...
\subsubsection*{\rev{Nutrient-dependent invasion resistance assays}}

% Supple Fig 7 - Nutr- pairwise invasion
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{supplementary_figs/Pairwise_Matrix_Dynamics_LN_improved.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{supplementary_figs/Pairwise_Matrix_Dynamics_MN_improved.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{supplementary_figs/Pairwise_Matrix_Dynamics_HN_improved.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{supplementary_figs/marginal_distributions_nutr_minus_only.png}
\caption{\rev{\textbf{Supplementary Fig.~11.} Nutr$-$ continuous similarity measures underlying categorical outcome classification. From left to right: PDI distribution, direction-independent parental asymmetry $|2\mathrm{PDI}-1|$, and squared retention magnitude $r^2 = u^2 + v^2$. PDI is computed as $(2/\pi)\arctan(u/v)$, with PDI defined as 1 for the boundary case $v=0$ and $u>0$.}}
\label{fig:suppl_s11}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{supplementary_figs/marginal_distributions_nutr_plus_only.png}
\caption{\rev{\textbf{Supplementary Fig.~12.} Nutr$+$ continuous similarity measures underlying categorical outcome classification. From left to right: PDI distribution, direction-independent parental asymmetry $|2\mathrm{PDI}-1|$, and squared retention magnitude $r^2 = u^2 + v^2$. PDI is computed as $(2/\pi)\arctan(u/v)$, with PDI defined as 1 for the boundary case $v=0$ and $u>0$.}}
\label{fig:suppl_s12}
\end{figure}

\subsubsection*{\rev{Pool-size, biomass, and dominant-species controls}}

% Supple Fig 13 - Pool-size dependency on community-level selection
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{supplementary_figs/pool_size_analysis.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{supplementary_figs/Fig_R1_1B_OD_vs_PDI.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{supplementary_figs/Fig_R1_1C_pairwise_corr_vs_OD.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{supplementary_figs/Fig_R1_3_per_medium_scatter.png}
\caption{\rev{\textbf{Supplementary Fig.~16.} Dominant-species removal control for the Fig.~5C PDI analysis. Per-medium scatter plots are shown without pooling Base and Nutr$+$ events. Rows show Base and Nutr$+$; columns show the original Fig.~5C calculation, removal of the most abundant species in the coalesced community from all three community composition vectors, and removal of the most abundant species from each parental community from all three composition vectors before recalculating PDI. Independent-event sample sizes are Base $n=34/34/34$ and Nutr$+$ $n=63/62/55$ for original / coalesced-community dominant removed / parental-community dominants removed, respectively. The third column is the stricter test. $R^2$ and slope annotations are computed on the reflected plotting data, as in Fig.~5C, and are used as descriptive summaries. Spearman $\rho$ and $p$ are computed on the independent, non-reflected events.}}
\label{fig:suppl_s16}
\end{figure}
...
\subsubsection*{\rev{Isolate pH phenotypes and parental-community pH structure}}

% Supple Fig 17 - Species-pH correlation
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{supplementary_figs/two_panel_ph_asv_figure.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{supplementary_figs/Fig_S23_ASV_vs_pH_combined.png}
...
\subsubsection*{\rev{Laboratory-stabilized natural sample-derived communities}}

% Supple Fig 19 - Natural rank-abundance Nutr-
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{supplementary_figs/rank_abundance_natural_Nutr-.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{supplementary_figs/rank_abundance_natural_Base.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{supplementary_figs/natural_taxonomic_distinctness.png}
...
\subsubsection*{\rev{Assembly-history and abundance-structure controls}}

% Supple Fig 23 - Assembly effect experimental
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{supplementary_figs/Fig_S26_assembly_effect_experimental_stacked_bar.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{supplementary_figs/rank_abundance_parental_vs_coalesced_Base.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{supplementary_figs/rank_abundance_parental_vs_coalesced_Nutr-.png}
...
\subsubsection*{\rev{Nutrient-condition coalescence matrices and time series}}
...
\begin{subfigure}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{supplementary_figs/timeseries_merged/Fig_1-3_timeseries_Nutr-_ex1_merged.png}
    \caption{}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{supplementary_figs/timeseries_merged/Fig_1-3_timeseries_Nutr-_ex2_merged.png}
    \caption{}
\end{subfigure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{supplementary_figs/timeseries_merged/Fig_1-3_timeseries_Nutr+_ex1_merged.png}
...
\subsubsection*{\rev{Assembly filtering, isolate phenotypes, and parental-overlap controls}}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{supplementary_figs/monoculture_od_growth_histograms.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{supplementary_figs/overlap_fraction_histogram.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{supplementary_figs/overlap_fraction_histogram_natural.png}
...
\subsubsection*{\rev{Shared-fate, classification-boundary, and additive-null controls}}

% Supple Fig 36 - Excess same-parent shared fate vs mu
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{supplementary_figs/invasion_fitness_supp.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{supplementary_figs/boundary_sensitivity_by_medium.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{supplementary_figs/Fig_R3_3_sim_parent_norm_asymmetry.png}
...
\subsubsection*{\rev{Mixed-sign and coefficient-structure simulation robustness}}

% Supple Fig 39 - Mixed-sign facilitative-tail gLV sensitivity
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{supplementary_figs/R3_4_mixed_sign_higher_order.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{supplementary_figs/R3_4_simulation.png}
\vspace{0.75em}
\includegraphics[width=\textwidth]{supplementary_figs/R3_4_pair_coupling_fine.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{supplementary_figs/R3_4_mutualistic_pair_fraction.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.55\textwidth]{supplementary_figs/skewness_null_comparison.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{supplementary_figs/Fig_R1_1A_winner_loser_OD.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{supplementary_figs/Fig_R1_2_acidalk_per_medium.png}
