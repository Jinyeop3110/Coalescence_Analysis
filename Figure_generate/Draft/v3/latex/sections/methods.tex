...
To empirically estimate interaction strength, we performed pairwise invasion assays among the 12 most abundant isolates. Each pair was tested in both directions (resident:invader = 95:5) and propagated through seven daily dilution cycles across all three nutrient conditions. Final compositions were determined by colony counting. An invasion was scored as failed if the invader remained below 1\% relative abundance. Pairwise outcomes were then classified as coexistence (both isolates above 10\% in both directions), exclusion (the same isolate drove its competitor below 1\% in both directions), or bistability (each isolate excluded the other when resident). The fraction of failed invasions served as a proxy for mean interaction strength (\figref{fig:fig4}B). Full experimental details are provided in Supplementary Methods.
