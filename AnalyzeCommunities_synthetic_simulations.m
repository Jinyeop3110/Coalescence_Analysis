...
for id_i=1:size(ID_list,1)
    ...
    T_toadd.S=ProS.S;
    T_toadd.I=ProS.I;
    x=GetCommunity_Sim(ProS,'x3');
    x1=GetCommunity_Sim(ProS,'x1');
    x2=GetCommunity_Sim(ProS,'x2');
    ...
    for i=1:T_toadd.Threshold_num
        ...
        T_toadd.("DiversityR_"+string(i))=Diversity1(x1,threshold);
        T_toadd.("DiversitySN_"+string(i))=Diversity2(x1,threshold);
        T_toadd.("DiversitySS_"+string(i))=Diversity3(x1,threshold);
    end
...
filename = session_name +['/processed_Communities_simulation.xlsx'];
